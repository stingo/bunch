...
*/ var handleSlimScroll = function() {
  ...
  generateSlimScroll = function(a) {
    if (!$(a).attr("data-init")) {
      ...
      /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
        ...
        ? ($(a).css("height", b), $(a).css("overflow-x", "scroll"))
        : $(a).slimScroll(c),
        $(a).attr("data-init", !0);
    }
  },
  ...
  handleMobileSidebarToggle = function() {
    ...
    $(".sidebar").bind("click touchstart", function(b) {
      0 !== $(b.target).closest(".sidebar").length
        ? (a = !0)
        : ((a = !1), b.stopPropagation());
    }),
      $(document).bind("click touchstart", function(b) {
        0 === $(b.target).closest(".sidebar").length && (a = !1),
      ...
      $("[data-click=right-sidebar-toggled]").click(function(b) {
        ...
        (d = $(window).width() < 979 ? "page-right-sidebar-toggled" : d),
          $(c).hasClass(d)
            ? $(c).removeClass(d)
            : a !== !0 ? $(c).addClass(d) : (a = !1),
          $(window).width() < 480 &&
            $("#page-container").removeClass("page-sidebar-toggled"),
  ...
  handlePanelAction = function() {
    ...
    return (
      ...
      $(document).on("hover", "[data-click=panel-remove]", function(a) {
        $(this).attr("data-init") ||
          ($(this).tooltip({
            title: "Remove",
            placement: "bottom",
      ...
      $(document).on("click", "[data-click=panel-reload]", function(a) {
        ...
        if (!$(b).hasClass("panel-loading")) {
          ...
          $(b).addClass("panel-loading"),
            $(c).prepend(d),
            setTimeout(function() {
              $(b).removeClass("panel-loading"),
                $(b)
                  .find(".panel-loader")
                  .remove();
            }, 2e3);
      ...
      void $(document).on("click", "[data-click=panel-expand]", function(a) {
        ...
        if ($("body").hasClass("panel-expand") && $(b).hasClass("panel-expand"))
            ...
            0 !== $(".sidebar .slimScrollDiv").length &&
              ($(window).width() <= 979
                ? $(".sidebar").each(function() {
                    if (
                      !$("#page-container").hasClass("page-with-two-sidebar") ||
      ...
      if (b) {
        ...
        $(".panel")
          ...
          .each(function() {
            ...
            a &&
              $.each(a, function(a, b) {
                var c = $('[data-sortable-id="' + b.id + '"]').not(
                  '[data-init="true"]'
                );
                if (0 !== $(c).length) {
                  var e = $(c).clone();
  ...
  handleIEFullHeightContent = function() {
    ...
    (b > 0 || navigator.userAgent.match(/Trident.*rv\:11\./)) &&
      $(
        '.vertical-box-row [data-scrollbar="true"][data-height="100%"]'
      ).each(function() {
        var a = $(this).closest(".vertical-box-row"),
          b = $(a).height();
        $(a)
          .find(".vertical-box-cell")
          .height(b);
      });
  },
    ...
    function a(a, b) {
      ...
      if (
        ...
        g != e && (h += 40),
          $(a)
            .find(".nav.nav-tabs")
            .animate({ marginLeft: "-" + h + "px" }, f);
      }
      e != g && g >= d
        ? $(a).addClass("overflow-right")
        : $(a).removeClass("overflow-right"),
        e >= d && g >= d
          ? $(a).addClass("overflow-left")
          : $(a).removeClass("overflow-left");
    }
    function b(a, b) {
      ...
      b)) {
        case "next":
          ...
          h <= e
            ...
            0 != g &&
              $(c)
                .find(".nav.nav-tabs")
                .animate({ marginLeft: "-" + g + "px" }, 150, function() {
        ...
        case "prev":
          var h = -d;
          h <= e
            ? ($(c).removeClass("overflow-left"), (g = 0))
            : (g = h - e + 80),
            $(c)
              .find(".nav.nav-tabs")
              .animate({ marginLeft: "-" + g + "px" }, 150, function() {
  ...
  handleMobileSidebar = function() {
    ...
    var a = 0;
    $(
      ".page-sidebar-minified .sidebar [data-scrollbar=true] a"
      ...
      $(
        ...
        if (
          ...
          var c =
              b.originalEvent.touches[0] || b.originalEvent.changedTouches[0],
            d = c.pageY,
            e = d - a;
          $(this)
            .closest("[data-scrollbar=true]")
      ...
      b)) {
        case "next":
          ...
          h <= e
            ...
            : (g = e - d - 128),
            0 != g &&
              $(c).animate({ marginLeft: "-" + g + "px" }, 150, function() {
                $(c)
